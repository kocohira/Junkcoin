...
static const int64 MAX_MONEY = 108000000 * COIN; // Junkcoin: maximum of 108M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; // Junkcoin: 720 blocks found a day. Priority cutoff is 1 junkcoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("04d5bfc3c0565520f3cf54513e4f1760fab6fe050c19756b1ac6d969fd53aef732ef33c5f401ebde7aa52147dc78213103ce7f4fe81e3de24a405ae3e2d4e01d82")))
